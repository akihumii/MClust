...
global MClust_CutOnBestProj MClust_Colors CBP_data
...
switch SwitchTag
    ...
    case {'Swap'}  %Separated from pulldown update detection Sept 2007 JCJ
        ...
        set(findobj('Tag', 'Cluster1pulldownCBP'),'BackgroundColor',MClust_Colors(CBP_data.iClust1+1,:),'ForegroundColor',1-MClust_Colors(CBP_data.iClust1+1,:))
        set(findobj('Tag', 'Cluster2pulldownCBP'),'BackgroundColor',MClust_Colors(CBP_data.iClust2+1,:),'ForegroundColor',1-MClust_Colors(CBP_data.iClust2+1,:))
