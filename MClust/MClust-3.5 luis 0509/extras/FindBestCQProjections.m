...
%         iClust2 = get(findobj('TooltipString','Cluster 2'),'Value');
        ...
        [f_1 MClust_Clusters{iClust}] = FindInCluster(MClust_Clusters{iClust}, MClust_FeatureData);
        
        if iClust2 ~= 0
            [f_2 MClust_Clusters{iClust2}] = FindInCluster(MClust_Clusters{iClust2}, MClust_FeatureData);
        else
