...
for o=1:1:n1  
    p=p+1;
    if(same_data_time_positive1(o)-start_time_positive1)>=50000   %  numbers 1000 represent per 100ms, calculating firing rate every 100ms
       q=q+1;
 ...
 temp_num_positive1 =temp_num_positive1/5  %if time in line 26 is 20000, then here temp_num_positive1/(20000/10000) to get firing rate in unit of Hz
...
for o=1:1:n2  
    p=p+1;
    if(same_data_time_positive2(o)-start_time_positive2)>=50000       
       q=q+1;
 ...
 temp_num_positive2 =temp_num_positive2/5
...
for o=1:1:n3  
    p=p+1;
    if(same_data_time_positive3(o)-start_time_positive3)>=50000     
       q=q+1;
...
temp_num_positive3 =temp_num_positive3/5
